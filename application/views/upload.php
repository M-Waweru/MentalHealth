<html >
    <head>
	<link rel="stylesheet" href=" <?php echo base_url();?>uploadanddownloadoffiles/css/bootstrap.min.css"/>
    <style type="text/css">
	#wrapper {
	margin: 0 auto;
	float: none;
    ...
    <title>Upload File</title>
     ...
     <body>
      ...
      <br>
        ...
        <form id="form3" enctype="multipart/form-data" method="post" action="Con2">
